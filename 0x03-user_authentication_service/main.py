...
def register_user(email: str, password: str) -> None:
    """
    Test to register a user email and password.
    Args:
        email: user email
...
def log_out(session_id: str) -> None:
    """
    Test for log out with session_id.
    Args:
        session_id: The session_id of the user.
    Returns:
        None
...
def reset_password_token(email: str) -> str:
    """
    Test for reset password token with the email.
    Args:
...
def update_password(email: str, reset_token: str,
    ...
    """
    Test updated password with the email,
    reset_token and new_password.
    Args:
        email: The user's email
        reset_token: The user's reset token
